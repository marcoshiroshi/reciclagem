    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('longitude', models.DecimalField(decimal_places=18, help_text='Coordenada geográfica da sua residência', max_digits=20, max_length=255, verbose_name='longitude')),
                ('latitude', models.DecimalField(decimal_places=18, help_text='Coordenada geográfica da sua residência', max_digits=20, max_length=255, verbose_name='latitude')),
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='catador_usuario', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
