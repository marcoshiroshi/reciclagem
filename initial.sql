...
INSERT INTO core_tipo (id, nome) VALUES
    (1, 'PAPEL'),
    (2, 'PAPELÃO'),
    (3, 'ALUMÍNIO'),
    (4, 'PLÁSTICO'),
...
INSERT INTO core_item (id, nome, tipo_id, peso) VALUES
    (1, 'JORNAIS E REVISTAS', 1, 200),
    (2, 'CAIXAS DE PAPELÃO', 2, 500),
    (3, 'PAPEL SULFITE', 1, 80),
    (4, 'LATAS DE REFRIGERANTE', 3, 15),
    (5, 'LATAS DE ALIMENTOS', 3, 20),
    (6, 'GARRAFAS PLÁSTICAS', 4, 30),
    (7, 'SACOLAS PLÁSTICAS', 4, 5),
    (8, 'EMBALAGENS DE PLÁSTICO', 4, 10),
    (9, 'GARRAFAS DE VIDRO', 5, 300),
    (10, 'POTES DE VIDRO', 5, 200),
    (11, 'FRASCOS DE PERFUME', 5, 50),
    (12, 'CAIXAS DE CEREAIS', 2, 150),
    (13, 'ENVELOPES', 1, 10),
    (14, 'EMBALAGENS DE LEITE', 4, 40),
    (15, 'EMBALAGENS DE IOGURTE', 4, 20),
    (16, 'SACOS DE BATATAS', 4, 15),
    (17, 'VIDRO DE JANELAS', 5, 1000),
    (18, 'FRASCOS DE COSMÉTICOS', 5, 75),
    (19, 'EMBALAGENS DE ALIMENTOS DE PLÁSTICO', 4, 50),
    (20, 'REVISTAS EM QUADRINHOS', 1, 120),
    (21, 'EMBALAGENS DE OVOS', 4, 45),
    (22, 'EMBALAGENS DE ALUMÍNIO DE ALIMENTOS', 3, 30),
    (23, 'GARRAFAS DE ÁGUA', 4, 25),
    (24, 'EMBALAGENS DE MARGARINA', 4, 40),
    (25, 'CAIXAS DE PIZZA', 2, 100),
    (26, 'EMBALAGENS DE SHAMPOO', 4, 60),
    (27, 'TUBOS DE PASTA DE DENTE', 4, 40),
    (28, 'EMBALAGENS DE SABONETE', 4, 20),
    (29, 'GARRAFAS DE VINHO', 5, 600),
    (30, 'VIDRO DE AQUÁRIO', 5, 2000),
    (31, 'EMBALAGENS DE COMIDA DE GATO', 4, 90),
    (32, 'LATAS DE TINTA', 6, 300),
    (33, 'LATAS DE ÓLEO DE COZINHA', 3, 80),
    (34, 'TUBOS DE CREME DENTAL', 4, 25),
    (35, 'EMBALAGENS DE BATATA FRITA', 4, 50),
    (36, 'PÁGINAS DE LIVROS', 1, 5),
    (37, 'EMBALAGENS DE SUCO DE FRUTAS', 4, 70),
    (38, 'EMBALAGENS DE CAFÉ', 4, 40),
    (39, 'FRASCOS DE MEDICAMENTOS', 4, 15),
    (40, 'TAMPAS DE GARRAFAS', 4, 2),
    (41, 'GARRAFAS DE CERVEJA', 5, 300),
    (42, 'EMBALAGENS DE CEREAL EM PLÁSTICO', 4, 100),
    (43, 'PAPEL DE EMBALAGEM DE PRESENTE', 1, 10),
    (44, 'LATAS DE AEROSSOL', 6, 20),
    (45, 'EMBALAGENS DE BISCOITOS', 4, 60),
    (46, 'PAPEL DE ALUMÍNIO', 3, 20),
    (47, 'LATAS DE SOPA', 6, 80),
    (48, 'CAIXAS DE SAPATOS', 2, 200),
    (49, 'LATAS DE CAFÉ', 6, 150),
    (50, 'SACOS DE LIXO', 4, 100),
    (51, 'LATAS DE CONSERVAS', 6, 120),
    (52, 'COPOS DE PLÁSTICO DESCARTÁVEIS', 4, 10),
    (53, 'EMBALAGENS DE MARGARINA', 4, 40),
    (54, 'TUBOS DE PASTA DE TOMATE', 4, 70),
    (55, 'LATAS DE CERVEJA', 3, 30),
    (56, 'PÁGINAS DE REVISTAS', 1, 40),
    (57, 'EMBALAGENS DE MANTEIGA', 3, 60),
    (58, 'SACOS DE PÃO', 1, 5),
    (59, 'GARRAFAS DE ÓLEO DE COZINHA', 5, 500),
    (60, 'TUBOS DE TINTA', 6, 50),
    (61, 'EMBALAGENS DE MACARRÃO', 1, 80),
    (62, 'CARTAZES DE EVENTOS', 1, 30),
    (63, 'CAIXAS DE OVOS', 4, 50),
    (64, 'EMBALAGENS DE SALGADINHOS', 4, 70),
    (65, 'LATAS DE ENERGÉTICO', 3, 40),
    (66, 'LATAS DE REFRIGERANTE DIETÉTICO', 3, 15),
    (67, 'EMBALAGENS DE CREME DE LEITE', 3, 40),
    (68, 'TUBOS DE PROTETOR SOLAR', 4, 30),
    (69, 'LATAS DE ATUM', 6, 80),
    (70, 'EMBALAGENS DE CEREAL EM VIDRO', 5, 200),
    (71, 'FOLHAS DE ALUMÍNIO', 3, 10),
    (72, 'GARRAFAS DE SUCO DE FRUTAS', 5, 250),
    (73, 'EMBALAGENS DE BOLACHAS', 4, 100),
    (74, 'COPOS DE PAPEL DESCARTÁVEIS', 1, 7),
    (75, 'EMBALAGENS DE KETCHUP', 5, 100),
    (76, 'TUBOS DE CREME PARA BARBEAR', 4, 50),
    (77, 'LATAS DE FRUTAS EM CONSERVA', 5, 150),
    (78, 'EMBALAGENS DE CHOCOLATE', 3, 60),
    (79, 'CAIXAS DE BRINQUEDOS', 4, 400),
    (80, 'EMBALAGENS DE SALSICHAS', 6, 50),
    (81, 'EMBALAGENS DE CAFÉ EM VIDRO', 5, 250),
    (82, 'LATAS DE SARDINHA', 6, 90),
    (83, 'GARRAFAS DE VINAGRE', 5, 150),
    (84, 'EMBALAGENS DE BATOM', 4, 10),
    (85, 'LATAS DE MILHO', 6, 120),
    (86, 'CAIXAS DE CEREAL EM PAPELÃO', 2, 150),
    (87, 'TUBOS DE CREME PARA AS MÃOS', 4, 30),
    (88, 'LATAS DE REFRIGERANTE DE 2 LITROS', 3, 80),
    (89, 'PAPEL DE SEDA', 1, 5),
    (90, 'EMBALAGENS DE CALDO DE GALINHA', 4, 30),
    (91, 'LATAS DE CERVEJA ARTESANAL', 3, 40),
    (92, 'TUBOS DE GEL PARA CABELO', 4, 60),
    (93, 'LATAS DE PÊSSEGOS EM CALDA', 6, 90),
    (94, 'CAIXAS DE PAPELÃO DE EMBALAGEM', 2, 300),
    (95, 'EMBALAGENS DE AMACIANTE', 4, 40),
    (96, 'TUBOS DE TINTA ACRÍLICA', 6, 100),
    (97, 'COPOS DE VIDRO DESCARTÁVEIS', 5, 100),
    (98, 'EMBALAGENS DE CEREAIS MATINAIS', 1, 120),
    (99, 'LATAS DE REFRIGERANTE DE 355 ML', 3, 12),
    (100, 'PAPEL DE ALUMÍNIO DE COZINHA', 3, 30),
    (101, 'EMBALAGENS DE CREME DENTAL', 4, 25),
    (102, 'TUBOS DE CREME PARA AS MÃOS', 4, 30),
    (103, 'LATAS DE PURÊ DE TOMATE', 6, 80),
    (104, 'COPOS DE PLÁSTICO PARA BEBIDAS', 4, 15),
    (105, 'EMBALAGENS DE MAIONESE', 5, 200),
    (106, 'EMBALAGENS DE LÂMINAS DE BARBEAR', 4, 15),
    (107, 'LATAS DE ABACAXI EM CALDA', 6, 90),
    (108, 'CARTÕES DE FELICITAÇÕES', 1, 10),
    (109, 'CAIXAS DE PAPELÃO DE MUDANÇA', 2, 1000),
    (110, 'TUBOS DE CREME PARA O ROSTO', 4, 40),
    (111, 'LATAS DE REFRIGERANTE DE 500 ML', 3, 20),
    (112, 'EMBALAGENS DE SABONETE EM BARRA', 4, 75),
    (113, 'TUBOS DE TINTURA PARA CABELO', 4, 50),
    (114, 'LATAS DE PÊSSEGOS SECOS', 6, 60),
    (115, 'CAIXAS DE SAPATOS DE PAPELÃO', 2, 400),
    (116, 'EMBALAGENS DE TINTA A ÓLEO', 6, 150),
    (117, 'LATAS DE CONSERVAS DE PICLES', 6, 100),
    (118, 'EMBALAGENS DE TALCO PARA BEBÊS', 4, 60),
    (119, 'LATAS DE SALMÃO ENLATADO', 6, 90),
    (120, 'LATAS DE PÊSSEGOS EM CALDA', 6, 90),
    (121, 'EMBALAGENS DE BRINQUEDOS', 4, 200),
    (122, 'LATAS DE MOLHO DE TOMATE', 6, 60),
    (123, 'EMBALAGENS DE CREME DE BARBEAR', 6, 40),
    (124, 'LATAS DE GRÃO-DE-BICO', 6, 100),
    (125, 'TUBOS DE CREME PARA OS PÉS', 4, 40),
    (126, 'LATAS DE CREME DE LEITE', 6, 80),
    (127, 'LATAS DE ATUM EM ÁGUA', 6, 90),
    (128, 'EMBALAGENS DE MÁQUINA DE BARBEAR', 4, 100),
    (129, 'LATAS DE CREME DE ESPINAFRE', 6, 80),
    (130, 'TUBOS DE LOÇÃO CORPORAL', 4, 100),
    (131, 'LATAS DE FEIJÃO', 6, 100),
    (132, 'EMBALAGENS DE LÁPIS DE COR', 1, 40),
    (133, 'LATAS DE SOPAS DE LEGUMES', 6, 90),
    (134, 'FRASCOS DE TINTURA DE CABELO', 4, 60),
    (135, 'LATAS DE FEIJÃO PRETO', 6, 100),
    (136, 'TUBOS DE GEL DE BANHO', 4, 200),
    (137, 'LATAS DE FEIJÃO VERMELHO', 6, 100);


INSERT INTO core_statusservico (id, nome) VALUES
    (1, 'CADASTRANDO PEDIDO'),
    (2, 'SOLICITANDO CATADOR'),
    (3, 'PEDIDO ACEITO'),
    (4, 'BUSCANDO PEDIDO'),
    (5, 'PEDIDO EM TRÂNSITO'),
    (6, 'ENTREGUE NO CENTRO DE COLETA')
;